...
import { Clock, Mail, Phone, RefreshCw, X } from "lucide-react";
...
const VirtualAppointmentCard: FC<AppointmentCardProps> = ({ appointment, isHighlighted = false }) => {
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
        ...
        <div className="flex flex-wrap gap-2 mt-2 md:mt-0">
          {/* Join button for virtual appointments - only show if can still join */}
          {canModifyAppointment && (
            <Link href={`/video-call/${appointment.appointmentId}/prepare`}>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-medium text-gray-900 dark:text-white">{t("appointmentDetails.virtualVisit")}</p>
              </div>
            </div>
          </div>
        </div>
...
export default VirtualAppointmentCard;
