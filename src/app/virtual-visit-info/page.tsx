...
export default function VirtualVisitInfoPage() {
  ...
  const handleFormSubmit = useCallback(async () => {
    if (!validateForm) {
      ...
      return toast.error("Please fill all the required field data");
    }
        ...
        <div className="mx-auto px-4 py-8 max-w-2xl pb-30">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Please provide your personal information to complete your virtual visit booking. This information helps us provide
